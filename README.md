...
<h3 align="center">Autonomous AI Agent Evolution Platform</h3>
...
| 角色 | 职责 | 适用场景 |
|------|------|---------|
| 🧠 **CEO** | 战略决策、对手分析、任务分配 | 核心，每队必备 |
| 🏗️ **架构师 / 代码设计师** | 系统架构设计、代码规范制定、技术选型 | 新项目启动、重构 |
| 💻 **开发工程师** | 功能开发、Bug 修复 | 核心，每队必备 |
| 🧪 **测试工程师** | 自动化测试、CI/CD 维护、覆盖率跟踪 | 质量保障 |
| 🔍 **代码审查师** | Code Review、代码质量门禁、安全审计 | 质量门禁 |
| 📋 **产品经理** | 需求分析、用户体验设计、功能规划 | 产品迭代 |
| ⚙️ **运维工程师** | 部署发布、基础设施、监控告警 | 上线阶段 |
| 📢 **市场运营** | 文档撰写、社区运营、推广发布 | 核心，每队必备 |
| 🔒 **安全工程师** | 安全审计、漏洞扫描、合规检查 | 安全敏感项目 |
```
